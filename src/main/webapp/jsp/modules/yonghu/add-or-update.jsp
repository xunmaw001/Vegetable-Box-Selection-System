                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label>用户账号</label>
                                    <input id="yonghuzhanghao" name="yonghuzhanghao" class="form-control"
                                           placeholder="用户账号">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>用户姓名</label>
                                    <input id="yonghuxingming" name="yonghuxingming" class="form-control"
                                           placeholder="用户姓名">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>密码</label>
                                ...
                                <div class="form-group col-md-6">
                                    <label>联系电话</label>
                                    <input id="lianxidianhua" name="lianxidianhua" class="form-control"
                                           placeholder="联系电话">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>电子邮箱</label>
                                    <input id="dianziyouxiang" name="dianziyouxiang" class="form-control"
                                           placeholder="电子邮箱">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>余额</label>
                                    <input id="money" name="money" class="form-control" placeholder="余额">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>余额</label>
                                    <input id="jifen" name="jifen" class="form-control" placeholder="积分">
                                </div>
...
<script>
    ...
    function dataBind() {
        ...
        $("#dianziyouxiang").val(ruleForm.dianziyouxiang);
        $("#money").val(ruleForm.money);
    ...
    function crossTable() {
        ...
        if (crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1) {
        ...
        )
            {
                ...
                if (res.data != null && res.data != '' && res.data.dianziyouxiang != null && res.data.dianziyouxiang != '') {

                    $("#dianziyouxiang").val(res.data.dianziyouxiang);
                }
                if (res.data != null && res.data != '' && res.data.money != null && res.data.money != '') {
