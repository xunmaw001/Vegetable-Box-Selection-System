				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.price" class="detail-item">
							<span>原价：</span>
							<s class="price" style="color: black">
								¥{{detail.price}}
							</s>
						</div>
						<div v-if="detail.price" class="detail-item">
			...
			var vue = new Vue({
				...
				methods: {
					...
					addCartTap() {
						...
						debugger
                        // let homeObj = JSONObject.fromObject(this.detai);
                         let homeObj0 = this.detail.price;
                         let homeObj1 = this.detail.discountprice;
						...
						layui.http.request('cart/list', 'get', {
							...
							layui.http.requestJson('cart/save', 'post', {
                                ...
                                discountprice: this.detail.discountprice
							}, (res) => {
								layer.msg("添加到购物车成功", {
									time: 2000,
									icon: 6
